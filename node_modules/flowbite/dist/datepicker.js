...
const pickerTemplate = (0,utils/* optimizeTemplateHTML */.zh)(`<div class="datepicker hidden">
  <div class="datepicker-picker inline-block rounded-lg bg-white dark:bg-white shadow-lg p-4">
    <div class="datepicker-header">
      <div class="datepicker-title bg-white dark:bg-white dark:text-w px-2 py-3 text-center font-inter"></div>
      <div class="datepicker-controls flex justify-between mb-2">
        <button type="button" class=" rounded-lg text-gray-500 dark:text-w bg-white dark:bg-white hover:text-white dark:hover:text-white text-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-gray-200 prev-btn"></button>
        <button type="button" class="text-sm rounded-lg text-gray-900 dark:text-wfont-inter py-2.5 px-5 bg-white dark:bg-white focus:outline-none focus:ring-2 focus:ring-gray-200 view-switch"></button>
        <button type="button" class=" rounded-lg text-gray-500 dark:text-w bg-white dark:bg-white hover:text-white dark:hover:text-white text-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-gray-200 next-btn"></button>
      </div>
    </div>
    ...
    <div class="datepicker-footer">
      <div class="datepicker-controls flex space-x-2 rtl:space-x-reverse mt-2">
        ...
        <button type="button" class="%buttonClass% clear-btn text-gray-900 font-bold  dark:text-w bg-white dark:bg-white border border-gray-300 dark:border-gray-600 focus:ring-4 focus:ring-blue-300 focus:!ring-primary-300 rounded-lg text-sm px-5 py-2 text-center w-1/2"></button>
      </div>
    </div>
  </div>
</div>`);
...
class DaysView extends View {
  ...
  render() {
    ...
    Array.from(this.grid.children).forEach((el, index) => {
      ...
      el.className = `datepicker-cell hover:text-white hover:bg-green-accent dark:hover:bg-green-accent block flex-1 leading-9 border-0 rounded-lg cursor-pointer text-center text-gray-900 dark:text-gray-900 font-inter text-sm ${this.cellClass}`;
