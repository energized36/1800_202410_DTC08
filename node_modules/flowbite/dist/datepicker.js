...
const defaultOptions = {
  ...
  maxView: 3,
  minDate: null,
  nextArrow: '<svg class="w-4 h-4 rtl:rotate-180 text-green-main" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/></svg>',
  orientation: 'auto',
  pickLevel: 0,
  prevArrow: '<svg class="w-4 h-4 rtl:rotate-180 text-green-main" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5H1m0 0 4 4M1 5l4-4"/></svg>',
  showDaysOfWeek: true,
  showOnClick: true,
  showOnFocus: true,
  startView: 0,
...
const pickerTemplate = (0,utils/* optimizeTemplateHTML */.zh)(`<div class="datepicker hidden">
  <div class="datepicker-picker inline-block rounded-lg bg-white dark:bg-white shadow-lg p-4">
    <div class="datepicker-header">
      <div class="datepicker-title bg-white dark:bg-white dark:text-gray-900 px-2 py-3 text-center font-inter"></div>
      <div class="datepicker-controls flex justify-between mb-2">
        <button type="button" class="bg-white dark:bg-white rounded-lg text-gray-500 dark:text-gray-900 hover:bg-green-accent dark:hover:bg-green-accent hover:text-white dark:hover:text-white text-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-gray-200 prev-btn"></button>
        <button type="button" class="text-sm rounded-lg text-gray-900 dark:text-gray-900 bg-white dark:bg-white font-inter py-2.5 px-5 hover:bg-green-accent dark:hover:bg-green-accent focus:outline-none focus:ring-2 focus:ring-gray-200 view-switch"></button>
        <button type="button" class="bg-white dark:bg-white rounded-lg text-gray-500 dark:text-gray-900 hover:bg-green-accent dark:hover:bg-green-accent hover:text-white dark:hover:text-white text-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-gray-200 next-btn"></button>
      </div>
    </div>
    <div class="datepicker-main p-1"></div>
    <div class="datepicker-footer">
      <div class="datepicker-controls flex space-x-2 rtl:space-x-reverse mt-2">
        <button type="button" class="%buttonClass% today-btn text-white font-bold bg-green-main !bg-primary-700 dark:bg-green-main dark:!bg-primary-600 hover:bg-blue-800 hover:!bg-primary-800 dark:hover:bg-green-main dark:hover:!bg-primary-700 focus:ring-4 focus:ring-blue-300 focus:!ring-primary-300 rounded-lg text-sm px-5 py-2 text-center w-1/2"></button>
        <button type="button" class="%buttonClass% clear-btn text-gray-900 font-bold  dark:text-gray-900 bg-white dark:bg-white border border-gray-300 dark:border-gray-600 hover:bg-green-accent dark:hover:bg-green-accent focus:ring-4 focus:ring-blue-300 focus:!ring-primary-300 rounded-lg text-sm px-5 py-2 text-center w-1/2"></button>
      </div>
    </div>
  </div>
</div>`);
...
const daysTemplate = (0,utils/* optimizeTemplateHTML */.zh)(`<div class="days">
  <div class="days-of-week grid grid-cols-7 mb-1">${(0,utils/* createTagRepeat */.em)('span', 7, {class: 'dow block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-inter text-sm'})}</div>
  <div class="datepicker-grid w-64 grid grid-cols-7">${(0,utils/* createTagRepeat */.em)('span', 42 , {class: 'block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-inter text-sm h-6 leading-6 text-sm font-medium text-gray-500 dark:text-gray-400'})}</div>
</div>`);
...
const calendarWeeksTemplate = (0,utils/* optimizeTemplateHTML */.zh)(`<div class="calendar-weeks">
  ...
  <div class="weeks">${(0,utils/* createTagRepeat */.em)('span', 6, {class: 'week block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-inter text-sm'})}</div>
</div>`);
...
class DaysView extends View {
  ...
  render() {
    ...
    Array.from(this.grid.children).forEach((el, index) => {
      ...
      el.className = `datepicker-cell hover:bg-green-accent dark:hover:bg-green-accent block flex-1 leading-9 border-0 rounded-lg cursor-pointer text-center text-gray-900 dark:text-gray-900 font-inter text-sm ${this.cellClass}`;
      el.dataset.date = current;
      el.textContent = date.getDate();

      if (current < this.first) {
        classList.add('prev', 'text-gray-500', 'dark:text-gray-900');
      } else if (current > this.last) {
        classList.add('next', 'text-gray-500', 'dark:text-gray-900');
      }
      ...
      if (this.selected.includes(current)) {
        classList.add('selected', 'bg-green-main', '!bg-primary-700', 'text-white', 'dark:bg-green-main', 'dark:!bg-primary-600', 'dark:text-gray-900');
        classList.remove('text-gray-900', 'text-gray-500', 'hover:bg-green-accent', 'dark:text-gray-900', 'dark:hover:bg-green-accent', 'dark:bg-gray-600', 'bg-gray-100', 'bg-gray-200');
      }
  ...
  refresh() {
    ...
    this.grid
      ...
      .forEach((el) => {
        el.classList.remove('range', 'range-start', 'range-end', 'selected', 'bg-green-main', '!bg-primary-700', 'text-white', 'dark:bg-green-main', 'dark:!bg-primary-600', 'dark:text-gray-900', 'focused');
        el.classList.add('text-gray-900', 'rounded-lg', 'dark:text-gray-900');
      });
    Array.from(this.grid.children).forEach((el) => {
      ...
      if (this.selected.includes(current)) {
        classList.add('selected', 'bg-green-main', '!bg-primary-700', 'text-white', 'dark:bg-green-main', 'dark:!bg-primary-600', 'dark:text-gray-900');
        classList.remove('text-gray-900', 'hover:bg-green-accent', 'dark:text-gray-900', 'dark:hover:bg-green-accent', 'bg-gray-100', 'bg-gray-200', 'dark:bg-gray-600');
      }
      if (current === this.focused) {
        classList.add('focused');
      }
...
class MonthsView extends View {
  ...
  render() {
    ...
    Array.from(this.grid.children).forEach((el, index) => {
      ...
      if (selected.includes(index)) {
        classList.add('selected', 'bg-green-main', '!bg-primary-700', 'text-white', 'dark:bg-green-main', 'dark:!bg-primary-600', 'dark:text-gray-900');
        classList.remove('text-gray-900', 'hover:bg-green-accent', 'dark:text-gray-900', 'dark:hover:bg-green-accent');
      }
  ...
  refresh() {
    ...
    this.grid
      .querySelectorAll('.range, .range-start, .range-end, .selected, .focused')
      .forEach((el) => {
        el.classList.remove('range', 'range-start', 'range-end', 'selected', 'bg-green-main', '!bg-primary-700', 'dark:bg-green-main', 'dark:!bg-primary-700', 'dark:text-gray-900', 'text-white', 'focused');
        el.classList.add('text-gray-900', 'hover:bg-green-accent', 'dark:text-gray-900', 'dark:hover:bg-green-accent');
      });
    Array.from(this.grid.children).forEach((el, index) => {
      const classList = el.classList;
      if (index > rangeStart && index < rangeEnd) {
