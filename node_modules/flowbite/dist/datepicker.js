  ...
  <div class="datepicker-picker inline-block rounded-lg bg-white dark:bg-white shadow-lg p-4">
    <div class="datepicker-header">
      ...
      <div class="datepicker-controls flex justify-between mb-2">
        <button type="button" class="bg-white dark:bg-white rounded-lg text-gray-500 dark:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-gray-900 dark:hover:text-white text-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-gray-200 prev-btn"></button>
        <button type="button" class="text-sm rounded-lg text-gray-900 dark:text-gray-900 bg-white dark:bg-white font-inter py-2.5 px-5 hover:bg-gray-100 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-200 view-switch"></button>
        <button type="button" class="bg-white dark:bg-white rounded-lg text-gray-500 dark:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-gray-900 dark:hover:text-white text-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-gray-200 next-btn"></button>
      </div>
    </div>
    ...
    <div class="datepicker-footer">
      <div class="datepicker-controls flex space-x-2 rtl:space-x-reverse mt-2">
        ...
        <button type="button" class="%buttonClass% clear-btn text-gray-900 font-bold  dark:text-gray-900 bg-white dark:bg-white border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 focus:ring-4 focus:ring-blue-300 focus:!ring-primary-300 rounded-lg text-sm px-5 py-2 text-center w-1/2"></button>
      </div>
    </div>
  </div>
</div>`);
...
class DaysView extends View {
  ...
  render() {
    ...
    Array.from(this.grid.children).forEach((el, index) => {
      ...
      el.className = `datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 block flex-1 leading-9 border-0 rounded-lg cursor-pointer text-center text-gray-900 dark:text-gray-900 font-inter text-sm ${this.cellClass}`;
      ...
      if (this.selected.includes(current)) {
        ...
        classList.remove('text-gray-900', 'text-gray-500', 'hover:bg-gray-100', 'dark:text-gray-900', 'dark:hover:bg-gray-600', 'dark:bg-gray-600', 'bg-gray-100', 'bg-gray-200');
      }
  ...
  refresh() {
    ...
    Array.from(this.grid.children).forEach((el) => {
      ...
      if (this.selected.includes(current)) {
        classList.add('selected', 'bg-green-main', '!bg-primary-700', 'text-white', 'dark:bg-green-main', 'dark:!bg-primary-600', 'dark:text-gray-900');
        classList.remove('text-gray-900', 'hover:bg-gray-100', 'dark:text-gray-900', 'dark:hover:bg-gray-600', 'bg-gray-100', 'bg-gray-200', 'dark:bg-gray-600');
      }
      if (current === this.focused) {
        classList.add('focused');
      }
  ...
  render() {
    ...
    Array.from(this.grid.children).forEach((el, index) => {
      ...
      if (selected.includes(index)) {
        classList.add('selected', 'bg-green-main', '!bg-primary-700', 'text-white', 'dark:bg-green-main', 'dark:!bg-primary-600', 'dark:text-gray-900');
        classList.remove('text-gray-900', 'hover:bg-gray-100', 'dark:text-gray-900', 'dark:hover:bg-gray-600');
      }
  ...
  refresh() {
    ...
    this.grid
      ...
      .forEach((el) => {
        ...
        el.classList.add('text-gray-900', 'hover:bg-gray-100', 'dark:text-gray-900', 'dark:hover:bg-gray-600');
      });
    Array.from(this.grid.children).forEach((el, index) => {
      const classList = el.classList;
      if (index > rangeStart && index < rangeEnd) {
